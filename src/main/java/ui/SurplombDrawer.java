...
public class SurplombDrawer extends JFrame
{
    ...
    private void drawSurplomb(Graphics g)
    {
        ...
        int x1f = (int) (pointInfDroitf.getX() * zoomFactor);
        int y1f = (int) (pointInfDroitf.getY()* zoomFactor);
        int x1r1f = (int) (rainureDroite1.getX()* zoomFactor);
        int y1r1f = (int) (rainureDroite1.getY()* zoomFactor);
        int x1r2f = (int) (rainureDroite2.getX()* zoomFactor);
        int y1r2f = (int) (rainureDroite2.getY()* zoomFactor);

        int x2f = (int) (pointSupDroitf.getX()* zoomFactor);
        int y2f = (int) (pointSupDroitf.getY()* zoomFactor);

        int x3f = (int) (pointSupGauchef.getX()* zoomFactor);
        int y3f = (int) (pointSupGauchef.getY()* zoomFactor);
        int x3r1f = (int) (rainureGauche1.getX()* zoomFactor);
        int y3r1f = (int) (rainureGauche1.getY()* zoomFactor);
        int x3r2f = (int) (rainureGauche2.getX()* zoomFactor);
        int y3r2f = (int) (rainureGauche2.getY()* zoomFactor);

        int x4f = (int) (pointInfGauchef.getX()* zoomFactor);
        int y4f = (int) (pointInfGauchef.getY()* zoomFactor);
        ...
        int x1a = (int) (pointInfDroita.getX()* zoomFactor);
        int y1a = (int) (pointInfDroita.getY()* zoomFactor);
        int x1r1a = (int) (rainureDroite1a.getX()* zoomFactor);
        int y1r1a = (int) (rainureDroite1a.getY()* zoomFactor);
        int x1r2a = (int) (rainureDroite2a.getX()* zoomFactor);
        int y1r2a = (int) (rainureDroite2a.getY()* zoomFactor);

        int x2a = (int) (pointSupDroita.getX()* zoomFactor);
        int y2a = (int) (pointSupDroita.getY()* zoomFactor);

        int x3a = (int) (pointSupGauchea.getX()* zoomFactor);
        int y3a = (int) (pointSupGauchea.getY()* zoomFactor);
        int x3r1a = (int) (rainureGauche1a.getX()* zoomFactor);
        int y3r1a = (int) (rainureGauche1a.getY()* zoomFactor);
        int x3r2a = (int) (rainureGauche2a.getX()* zoomFactor);
        int y3r2a = (int) (rainureGauche2a.getY()* zoomFactor);

        int x4a = (int) (pointInfGauchea.getX()* zoomFactor);
        int y4a = (int) (pointInfGauchea.getY()* zoomFactor);
        //
        ...
        int x1g = (int) (pointInfDroitg.getX()* zoomFactor);
        int y1g = (int) (pointInfDroitg.getY()* zoomFactor);
        int x1r1g = (int) (rainureDroite1g.getX()* zoomFactor);
        int y1r1g = (int) (rainureDroite1g.getY()* zoomFactor);
        int x1r2g = (int) (rainureDroite2g.getX()* zoomFactor);
        int y1r2g = (int) (rainureDroite2g.getY()* zoomFactor);

        int x2g = (int) (pointSupDroitg.getX()* zoomFactor);
        int y2g = (int) (pointSupDroitg.getY()* zoomFactor);

        int x3g = (int) (pointSupGaucheg.getX()* zoomFactor);
        int y3g = (int) (pointSupGaucheg.getY()* zoomFactor);
        int x3r1g = (int) (rainureGauche1g.getX()* zoomFactor);
        int y3r1g = (int) (rainureGauche1g.getY()* zoomFactor);
        int x3r2g = (int) (rainureGauche2g.getX()* zoomFactor);
        int y3r2g = (int) (rainureGauche2g.getY() * zoomFactor);

        int x4g = (int) (pointInfGaucheg.getX()* zoomFactor);
        int y4g = (int) (pointInfGaucheg.getY()* zoomFactor);
        ...
        int x1d = (int) (pointInfDroitd.getX()* zoomFactor);
        int y1d = (int) (pointInfDroitd.getY()* zoomFactor);
        int x1r1d = (int) (rainureDroite1d.getX()* zoomFactor);
        int y1r1d = (int) (rainureDroite1d.getY()* zoomFactor);
        int x1r2d = (int) (rainureDroite2d.getX()* zoomFactor);
        int y1r2d = (int) (rainureDroite2d.getY()* zoomFactor);

        int x2d = (int) (pointSupDroitd.getX()* zoomFactor);
        int y2d = (int) (pointSupDroitd.getY()* zoomFactor);

        int x3d = (int) (pointSupGauched.getX()* zoomFactor);
        int y3d = (int) (pointSupGauched.getY()* zoomFactor);
        int x3r1d = (int) (rainureGauche1d.getX()* zoomFactor);
        int y3r1d = (int) (rainureGauche1d.getY()* zoomFactor);
        int x3r2d = (int) (rainureGauche2d.getX()* zoomFactor);
        int y3r2d = (int) (rainureGauche2d.getY()* zoomFactor);

        int x4d = (int) (pointInfGauched.getX()* zoomFactor);
        int y4d = (int) (pointInfGauched.getY()* zoomFactor);
